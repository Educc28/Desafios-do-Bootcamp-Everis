/* Desafio
Há um país denominado Lilipute, todos os habitantes ficam felizes em pagar seus impostos, pois sabem que nele não existem políticos corruptos e os recursos arrecadados são utilizados em benefício da população, sem qualquer desvio. 
...
if (sal <= 2000){
  ...
  result = ((sal - 2000) * 0.08).toFixed(2);
  console.log('R$ ' + result);
}
else if (sal <= 4500){
  result = (80 + (sal - 3000) * 0.18).toFixed(2);
  console.log('R$ ' + result);
}
else{
  result = (80 + 270 + (sal - 4500) * 0.28).toFixed(2);
  console.log('R$ ' + result);
}
